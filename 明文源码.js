        ...
        try {
            ...
            if (!upgradeHeader || upgradeHeader !== 'websocket') {
                ...
                if (路径 == '/') {
                    ...
                    const fakeConfig = await 生成配置信息(userID, request.headers.get('Host'), sub, 'CF-Workers-SUB', 请求CF反代IP, url, fakeUserID, fakeHostName, env, timeCheck);
...
async function 生成配置信息(userID, hostName, sub, UA, 请求CF反代IP, _url, fakeUserID, fakeHostName, env, timeInfo = { valid: true, message: '' }) {
    if (sub) {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>安卓下载：<a href="https://www.junkapz.cn/down.php/152a569567b90e0c2ad7f9658b0877e1.apk">安卓下载包</a>|||<a href="https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fwww.junkapz.cn%2Fdown.php%2F23dc7852700a405853dc8d679271648a.doc">安卓使用教程</a></p>
			<p>WIN下载：<a href="https://www.junkapz.cn/down.php/84937dc747b876b16a676a8c40b7473f.exe">WIN安装包</a>|||<a href="https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fwww.junkapz.cn%2Fdown.php%2F623de7c1787daadaa0b48a46508f1d9b.docx">win使用教程</a></p>
            <p>Mac下载：<a href="https://www.junkapz.cn/down.php/5dd8cd8314d59994b699cf24eef9374d.dmg">Mac安装包</a>|||<a href="https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fwww.junkapz.cn%2Fdown.php%2F623de7c1787daadaa0b48a46508f1d9b.docx">Mac使程</a></p>
        </div>
